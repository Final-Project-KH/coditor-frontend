...
export default () => {
  ...
  const editor = useEditor({
    ...
    content: `<p><b>[개발 스터디 모집 내용 예시]</b></p>
        <ul>
          <li>스터디 주제 : </li>
          <li>스터디 목표 : </li>
          <li>예상 일정(횟수) : </li>
        ...
        <p><span style="color: #868e96;"><sub>* 참고 사항 : 스터디 게시판에 영리를 목적으로 하는 게시글(유료 과외 및 멘토링 등)을 작성한 경우 해당 글은 운영 방침에 의해 중단, 삭제될 수 있음을 안내드립니다.</sub></span></p>`,
  });
    ...
    <>
      <TipTapBox>
        <EditorArea><ToolBarContainer>
          <ToolBar editor={editor} /></ToolBarContainer>
          <EditorContent
