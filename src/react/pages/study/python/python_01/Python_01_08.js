...
import Python_01_08_M from "./Python_01_08_M";
          ...
          <Container>
            ...
            <RightContainer>
              <EachClass>
                ...
                <ClassContentsContainer>
                  <ClassContentsText>
                    연산자는 프로그램에서 값을 계산하거나 변수에 대해 연산을
                    수행하는 기호입니다. 다양한 종류의 연산자가 있으며, 각기
                    다른 목적에 사용됩니다. 아래는 주요 연산자와 그 사용
                    예제입니다.
                  </ClassContentsText>
                  <br />
                  <ClassContentsTitle2>산술연산자</ClassContentsTitle2>
                  <ClassContentsText>
                    숫자형 데이터 사이에서 기본적인 사칙연산을 수행합니다.
                    정수형 연산은 정수형으로, 실수형 연산은 실수형으로 결과를
                    반환합니다. 문자열에 대해서도 일부 산술연산이 가능합니다.
                  </ClassContentsText>
                  <br />
                  ...
                  <ClassContentsText>
                    변수에 값을 할당하거나, 복합적으로 값을 갱신할 때
                    사용됩니다.
                    <ClassContentsTextTab>
                      - 대입 연산자의 종류 : =, +=, -=, *=, /=, //=, %=
                    </ClassContentsTextTab>
                    <ClassContentsCodeBox>
                      대입 연산자는 기본적으로 (=)이다. (==)은 같다라는
                      비교연산자이므로 잘 구별해서 사용해야 합니다.
                    </ClassContentsCodeBox>
                    <Python_01_08_Code05 />
                  </ClassContentsText>
                  <br />
                  ...
                  <ClassContentsText>
                    ...
                    <ClassContentsCodeBox>
                      값의 범위를 체크하는 비교 연산자 사용시 변수를 한번만 넣을
                      수 있습니다. {`(예,  0 < x ≤ 100)`}
                    </ClassContentsCodeBox>
                    <Python_01_08_Code06 />
                  </ClassContentsText>
                  ...
                  <ClassContentsText>
                    인간이 사용하는 진법은 10진법 입니다. 0 ~ 9까지의 숫자로
                    총개의 숫자를 의미 합니다.
                    <br />
                    컴퓨터는 2진법을 사용 합니다. 2진법은 0과1반 있으며,
                    전기적인 신호인 ON/OFF를 의미 합니다.
                    <br />
                    16진법은 프로그램 작성시 많이 사용되며, 2진번 4자리와
                    일치하므로 사용에 편리 하여 자주 사용 됩니다.
                    <ClassContentsTextTab>
                      - 2진수(0b) : 2진수를 의미 합니다.
                      <br />
                      - 8진수(0o) : 8진수를 의미 합니다.
                  ...
                  <ClassContentsText>
                    <font color="#2c79c1">
                      <b>
                        <i>
                          윤년 판단하기 (조건문, 나머지 연산자, 비교연산자,
                          논리연산자)
                        </i>
                      </b>
                    </font>
                    <br />
                    달력(양력)은 지구가 태양을 공전하는 시간을 기준으로
                    작성된다.
                    <br />
