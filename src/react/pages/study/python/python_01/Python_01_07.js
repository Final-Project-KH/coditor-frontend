...
import Python_01_07_M from "./Python_01_07_M";
            ...
            <RightContainer>
              <EachClass>
                ...
                <ClassContentsContainer>
                  ...
                  <ClassContentsText>
                    문자열은 문자들의 집합으로, 파이썬에서는 다음 방법으로
                    표현할 수 있습니다: 1. <b>큰따옴표("")</b>로 감싸기
                    <ClassContentsTextTab>
                      - 예 : "안녕하세요"
                    </ClassContentsTextTab>
                    2. <b>작은따옴표('')</b>로 감싸기
                    ...
                    3. <b>큰따옴표 3개(""" """)</b>로 감싸기 : 여러 줄 문자열에
                    사용
                    <ClassContentsTextTab>
                      - 예 : """ 안녕하세요. 반갑습니다. """"
                    </ClassContentsTextTab>
                    4. <b>작은따옴표 3개(''' ''')</b>로 감싸기 : 여러 줄
                    문자열에 사용
                    <ClassContentsTextTab>
                      - 예 : ''' 안녕하세요. 반갑습니다.'''
                    </ClassContentsTextTab>
                  ...
                  <Python_01_07_Code04 /><br />
                  <ClassContentsTitle2>
                    문자열 슬라이싱(Slicing)
                  </ClassContentsTitle2>
                  <ClassContentsText>
                    문자열의 일부를 잘라내는 작업을 <b>슬라이싱</b>이라고
                    합니다.
                    <ClassContentsTextTab>
                  ...
                  <ClassContentsText>
                    ...
                    <font color="#2c79c1">
                      <b>
                        <i>
                          인덱싱의 범위는 0부터 시작 합니다. 프로그램의 모든
                          시작 위치는 0 입니다.
                          <br />
                          그러므로 항상 실제 숫자보다 1이 작다는걸 유의 해야
                          합니다.
                        </i>
                      </b>
                    </font>
                  ...
                  <ClassContentsText>
                    - <b>find()</b> : 찾은 부분 문자열의 첫 번째 인덱스를
                    반환합니다. 부분 문자열을 찾지 못하면 -1을 반환합니다.
                    <br />- <b>index()</b> : 찾은 부분 문자열의 첫 번째 인덱스를
                    반환합니다. 부분 문자열을 찾지 못하면 ValueError 예외를
                    발생시킵니다.
                    <Python_01_07_Code11 />
                  </ClassContentsText>
                  <ClassContentsTitle3>
                  ...
                  <ClassContentsText>
                    ...
                    - 규칙3 : 남은 글자 중 처음 세자리 + 글자 갯수 + 글자에
                    포함된 'o' 갯수 +글자에 포함된 'k' 갯수+ '!' +
                    자신의이니셜(예: 'coditor')
                    <br />
                    <Python_01_07_Code16 />
                  </ClassContentsText>
