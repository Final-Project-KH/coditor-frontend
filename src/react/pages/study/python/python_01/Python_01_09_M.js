    ...
    <Wrap>
      ...
      <Container>
        {/* <EachClass>
            ...
            <ClassContentsContainer> */}
        <ClassContentsText>
          제어문은 프로그램의 흐름을 제어하는 데 사용됩니다. 순차적인 흐름을
          조건에 따라 변경하거나, 특정 코드를 반복 실행할 수 있도록 해줍니다.
          제어문이 없다면 프로그램은 입력값과 상관없이 항상 동일한 흐름을 따르게
          됩니다.
        </ClassContentsText>
        <ClassContentsTitle3>제어문의 종류</ClassContentsTitle3>
        <ClassContentsText>
          1. <b>조건문 (if, elif, else)</b> : 입력 값에 따라 특정 코드 블록을
          선택적으로 실행합니다.
          <br />
          2. <b>반복문 (while, for)</b> : 조건이 충족되는 동안 특정 코드 블록을
          반복 실행합니다.
        </ClassContentsText>
        <br />
        <hr />
        <br />
        <ClassContentsTitle2>조건문(if, elif, else)</ClassContentsTitle2>
        <ClassContentsText>
          조건문은 조건을 평가하여 참(True)인지 거짓(False)인지에 따라 특정
          코드를 실행합니다.
        </ClassContentsText>
        <ClassContentsTitle2>if ~ else문</ClassContentsTitle2>
        <ClassContentsText>
          조건이 참이면 if 블록을 실행하고, 거짓이면 else 블록을 실행합니다.
          <Python_01_09_Code01 />
        </ClassContentsText>
        <br />
        <ClassContentsTitle3>if ~ elif ~ else</ClassContentsTitle3>
        <ClassContentsText>
          다양한 조건을 확인할 때 사용됩니다. elif는 여러 개 사용할 수 있으며,
          순차적으로 조건을 평가합니다.
          <Python_01_09_Code02 />
        </ClassContentsText>
        <br />
        ...
        <ClassContentsText>
          ...
          <br />- lower()를 사용해 입력값을 소문자로 변환하면 대소문자 구분 없이
          비교할 수 있습니다.
        </ClassContentsText>
        <br />
        <hr />
        <br />
        <ClassContentsTitle2>학점 계산 프로그램 (실습)</ClassContentsTitle2>
        <ClassContentsText>
          학생의 이름, 학번, 그리고 국어, 영어, 수학 점수를 입력받아 평균 점수에
          따라 학점을 출력하는 프로그램 작성
          <Python_01_09_Code04 />
          - 평균 점수를 소수점 두 자리까지 출력하기 위해 .2f 형식을
          사용했습니다.
          <br />- 조건은 위에서부터 순차적으로 평가되므로, 하위 조건은 별도로
          제한하지 않아도 됩니다.
        </ClassContentsText>
        <br />
        <hr />
        ...
        <ClassContentsText>
          아이디는 8자리 이상이어야 하며, 비밀번호는 8~16자리 사이여야 하고
          아이디를 포함해서는 안 됩니다.
          <Python_01_09_Code06 />
        </ClassContentsText>
        <br />
        ...
        <ClassContentsText>
          - 3자리의 정수를 입력을 받아 100의자리, 10자리, 1의 자리로 나누어 담고
          가장 큰수를 찾아서 출력
          <br />
          - 예) 입력 : 574, 출력 : 7
          <Python_01_09_Code08 />
        ...
        <ClassContentsText>
          ...
          <Python_01_09_Code10 />- pay:,.0f를 사용해 급여를 천 단위 콤마로
          표시했습니다.
        </ClassContentsText>
        {/* </ClassContentsContainer>
          </EachClass> */}
