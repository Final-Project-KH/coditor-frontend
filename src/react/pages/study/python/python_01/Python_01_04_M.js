      ...
      <TopBoxWide2>
        <TopBox2>
          ...
          <TopBoxLink onClick={() => handleRefresh()}>
            <TopBoxText2>04. Python 기본</TopBoxText2>
          </TopBoxLink>
        </TopBox2>
      </TopBoxWide2>
      <Container>
        ...
        <ClassContentsText>
          <ClassContentsTextTab>
            ...
            <br />
            - 간단한 프로그램은 터미널(명령 프롬프트 또는 PowerShell)에서 실행
            가능합니다.
            <br />- 터미널에서 파이썬 실행 모드 ({`>>>`} 상태) 종료 : exit()
            또는 quit() 입력
          </ClassContentsTextTab>
        </ClassContentsText>
        <br />
        ...
        <ClassContentsText>
          ...
          <ClassContentsTextTab>
            ...
            <br />- PascalCase : 모든 단어의 첫 글자는 대문자 (주로 클래스
            이름에 사용)
          </ClassContentsTextTab>
          <Python_01_04_Code03 />
        </ClassContentsText>
