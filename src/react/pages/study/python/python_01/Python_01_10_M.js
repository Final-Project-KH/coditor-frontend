      ...
      <TopBoxWide2>
        <TopBox2>
          ...
          <TopBoxLink onClick={() => handleRefresh()}>
            <TopBoxText2>10. 반복문</TopBoxText2>
          </TopBoxLink>
        </TopBox2>
      </TopBoxWide2>
      <Container>
        ...
        <ClassContentsText>
          ...
          <br />- <b>특징</b> : 조건이 거짓이 될 때까지 반복. 조건을 설정하지
          않으면 무한 반복(while True)을 사용할 수 있음
        </ClassContentsText>
        <br />
        <hr />
        <br />
        ...
        <ClassContentsText>
          - 유효한 나이를 입력받을 때까지 반복해서 사용자에세 입력을 요구하는
          예제
          <br />
        ...
        <ClassContentsText>
          ...
          <br />
          범위기반 반복문으로 많이 사용되며, 반드시 반복문에 대한 종료 조건이
          있어야 합니다.
        </ClassContentsText>
        <ClassContentsTitle2>for 요소 in 시퀀스</ClassContentsTitle2>
        <ClassContentsText>
          "for-in"문은 <b>시퀀스(리스트, 튜플, 문자열 등)</b>의 각 요소를
          순회하는 데 사용됩니다. 일반적인 구문은 다음과 같습니다. (자바의
          향상된 for문과 동일)
          <Python_01_10_Code04 />
        </ClassContentsText>
        <br />
        ...
        <ClassContentsText>
          "for-range"문은 숫자 범위를 순회하는 데 사용됩니다. 일반적인 구문은
          다음과 같습니다 :
        </ClassContentsText>
        <br />
        <ClassContentsTitle3>
...
`
        ...
        <ClassContentsText>
          - continue 문을 만나면 아래의 문자을 수행하지 않고 반복문으로
          이동한다.
          <Python_01_10_Code13 />
        </ClassContentsText>
        <br />
        ...
        <ClassContentsText>
          - chr : 유니코드 값을 입력 받아 그 코드에 해당하는 문자를 출력하는
          함수
          <br />
        ...
        <ClassContentsText>
          ...
          <ClassContentsTextTab>
            - 이름 입력
            <br />
            - 나이 입력 : 1 ~ 199까지 입력 받고 잘못된 값이 오면 재입력 요청을
            한다.
            <br />
            - 성별 입력 : 영문자 (M과m은 남성) (F와 f는 여성)으로 입력 받고
            나머지는 재입력 요청을 한다.
            <br />
        ...
        <ClassContentsText>
          👉 <b>문제</b>
          <br />
          동호는 새악대로 T 통신사의 새 핸드폰 옴머나를 샀다. 새악대로 T
          ...
          영식 요금제는 30초마다 10원씩 청구된다. 이 말은 만약 29초 또는 그 보다
          적은 시간 통화를 했으면 10원이 청구된다. 만약 30초부터 59초 사이로
          통화를 했으면 20원이 청구된다.
          <br />
          민식 요금제는 60초마다 15원씩 청구된다. 이 말은 만약 59초 또는 그 보다
          적은 시간 통화를 했으면 15원이 청구된다. 만약 60초부터 119초 사이로
          통화를 했으면 30원이 청구된다.
          <br />
          동호가 저번 달에 새악대로 T 통신사를 이용할 때 통화 시간 목록이
          주어지면 어느 요금제를 사용 하는 것이 저렴한지 출력하는 프로그램을
          작성하시오.
          <br />
          <br />
          👉 <b>입력</b>
          <br />
          동호가 저번 달에 이용한 통화의 개수 N이 주어진다. N은 20보다 작거나
          같은 자연수이다. 둘째 줄에 통화 시간 N개가 주어진다. 통화 시간은
          10,000보다 작거나 같은 자연수이다.
          <br />
          <br />
          👉 <b>출력</b>
          <br />
          첫째 줄에 싼 요금제의 이름을 출력한다. 그 후에 공백을 사이에 두고
        ...
        <ClassContentsText>
          ...
          👉 <b>입력</b>
          <br />
          첫째 줄에 영어 소문자와 대문자로만 이루어진 단어가 주어진다. 단어의
          길이는 최대 100이다.
          <br />
          <br />
          👉 <b>출력</b>
        ...
        <ClassContentsText>
          👉 <b>문제</b>
          <br />
          세 개의 자연수 A, B, C가 주어질 때 A × B × C를 계산한 결과에 0부터
          9까지 각각의 숫자가 몇 번씩 쓰였는지를 구하는 프로그램을 작성하시오.
          <br />
          예를 들어 A = 150, B = 266, C = 427 이라면 A × B × C = 150 × 266 × 427
          = 17037300 이 되고, 계산한 결과 17037300 에는 0이 3번, 1이 1번, 3이
          2번, 7이 2번 쓰였다.
          <br />
          <br />
          👉 <b>입력</b>
        ...
        <ClassContentsText>
          ...
          <br />
          - while 반복문은 조건식을 기반으로 특정 코드를 반복해서 실행 할 때
          사용합니다.
          <br />- <b>break</b>는 반복문을 탈출 할 때 사용합니다.
          <br />- <b>continue</b>는 반복문에서 아래의 구간을 수행하지 않고
          반복문의 조건으로 이동할 때 사용합니다.
          <br />
        </ClassContentsText>
        {/* </ClassContentsContainer>
          </EachClass> */}
