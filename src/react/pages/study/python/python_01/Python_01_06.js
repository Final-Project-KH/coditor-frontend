        ...
        <Wrap>
          ...
          <Container>
            ...
            <RightContainer>
              <EachClass>
                <ClassHeader>
                  <ClassHeaderTitle>자료형과 표준 데이터 형식</ClassHeaderTitle>
                </ClassHeader>
                <ClassContentsContainer>
                  <ClassContentsTitle2>자료형이란?</ClassContentsTitle2>
                  <ClassContentsText>
                    <b>자료형</b>은 데이터를 저장하기 위해 미리 정의된 데이터의
                    형태를 의미합니다. Python은 변수에 값이 할당될 때 자료형이
                    자동으로 결정되지만, 데이터형에 대한 이해는 필수적입니다.
                  </ClassContentsText>
                  <br />
                  <ClassContentsTitle3>
                    파이썬의 주요 자료형
                  ...
                  <ClassContentsText>
                    <b>변수</b>는 데이터를 저장하기 위해 메모리 공간에 이름을
                    부여하는 것을 의미합니다.
                    <ClassContentsTextTab>
                      - Python은 값을 할당하는 순간 자동으로 변수 선언과 자료형
                      결정이 이루어집니다.
                      <br />- 대입 연산자 =를 사용하며, ==는 비교 연산자이므로
                      혼동하지 않도록 주의하세요.
                    </ClassContentsTextTab>
                  </ClassContentsText>
                  <br />
                  ...
                  <ClassContentsText>
                    Python에서는 type() 함수를 사용하여 변수의 자료형을 확인할
                    수 있습니다.
                  </ClassContentsText>
                  <Python_01_06_Code05 />
                  <br />
                  ...
                  <ClassContentsText>
                    ...
                    - 실수(float) : 소수점이 포함된 숫자. 예 : 123.45, -1234.5,
                    3.4e10
                    <br />
                  </ClassContentsText>
                  <br />
                  ...
                  <ClassContentsText>
                    1. Python은 <b>동적 타입</b> 언어로, 변수 선언 시 자료형을
                    명시하지 않아도 됩니다.
                    <br />
                    ...
                    <br />
                    4. 자료형은 Python의 기본 클래스이며, 이를 통해 다양한
                    연산과 조작이 가능합니다.
                    <br />
                  </ClassContentsText>
                </ClassContentsContainer>
