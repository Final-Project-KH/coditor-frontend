...
import Python_01_01_M from "./Python_01_01_M";
              ...
              <EachClass>
                ...
                <ClassContentsContainer>
                  ...
                  <ClassContentsText>
                    ...
                    언어에는 파이썬 외에도 Java, JavaScript, C, C++ 등이 있으며,
                    앱 개발에는 Kotlin이나 Swift 같은 언어도 사용됩니다.
                  </ClassContentsText>
                  ...
                  <ClassContentsText>
                    ...
                    프로그래밍 언어로 구체적으로 표현하는 것을 말합니다. 이
                    과정에는 규칙성을 찾아내고 효율적인 방법을 설계하는 논리적
                    사고가 필요합니다.
                    <br />
                    프로그래밍의 일반적인 과정은 다음과 같습니다 :
                    <ClassContentsTextTab>
                      - 문제 인식 → 프로그램 설계 → 프로그램 구현 → 테스트와
                      디버깅 → 유지보수
                    </ClassContentsTextTab>
                    파이썬 강의를 통해 코딩을 배우면서, 여러분은 컴퓨터가 문제를
                    해결하는 방식처럼 복잡한 문제를 단순화하고 이를 논리적이고
                    효율적으로 해결하는 능력을 배울 수 있습니다. 이는 중요한
                    학습 목표입니다.
                  </ClassContentsText>
                  <br />
                  ...
                  <ClassContentsText>
                    ...
                    언어입니다. 현재 전 세계에서 가장 인기 있는 프로그래밍 언어
                    중 하나입니다. 다양한 플랫폼에서 사용 가능하며, 풍부한
                    라이브러리 덕분에 사용이 쉽고 개발 속도가 빠른 것이
                    장점입니다.
                  </ClassContentsText>
                  <br />
                  ...
                  <ClassContentsText>
                    파이썬은 교육용으로 만들어졌기 때문에 코드가 간결하고
                    가독성이 좋습니다. 문법이 사람의 사고방식과 유사하여 코딩
                    과정이 영작하는 것처럼 느껴질 정도로 쉽습니다. 생산성이 높아
                    개발 속도가 빠르다는 장점이 있습니다.
                    <br />
                    <br />
                    · C++로 “Hello World” 출력
                    <br />
                  ...
                  <ClassContentsText>
                    파이썬은 코드의 <b>들여쓰기</b>로 블록을 구분합니다. 이는
                    다른 언어가 {}를 사용하는 것과 다릅니다. 이 방식은 코드의
                    일관성을 유지하도록 하여, 다른 사람이 작성한 코드도 읽기
                    쉽게 만들어 줍니다.
                  </ClassContentsText>
                  <ClassContentsTitle3>
                  ...
                  <ClassContentsText>
                    ...
                    않아도 작성된 부분까지 테스트가 가능합니다. C/C++이나 자바
                    같은 언어는 <b>컴파일 언어</b>인 반면, 파이썬은 인터프리터
                    언어로 컴파일 언어에 비해 실행 속도가 느릴 수 있습니다.
                  </ClassContentsText>
                  <ClassContentsTitle3>멀티 패러다임 언어</ClassContentsTitle3>
                  <ClassContentsText>
                    파이썬은 <b>절차 지향</b>(C 언어)과 <b>객체 지향</b>(자바
                    등) 두 가지 특성을 모두 가지고 있습니다.
                    <ClassContentsTextTab>
                  ...
                  <ClassContentsText>
                    파이썬은 다양한 자료형과 라이브러리를 제공하며, 다른
                    언어와의 연동성도 좋습니다(C/C++ 등). 이를 통해 높은
                    생산성과 빠른 개발 속도를 자랑합니다.
                  </ClassContentsText>
                  <br />
                  <ClassContentsTitle2>
                    활용 영역 (라이브러리 활용)
                  ...
                  <ClassContentsText>
                    파이썬은 다양한 라이브러리를 활용하여 여러 분야에서
                    사용됩니다 :
                    <ClassContentsTextTab>
                      - <b>업무 자동화</b> : 반복적인 사무 업무(예: 엑셀과
                      연동)를 자동화합니다.
                  ...
                  <ClassContentsText>
                    ...
                    연산이 필요한 영상 처리, 압축 알고리즘 등은 파이썬의 주요
                    활용 영역이 아닙니다.
