      ...
      <TopBoxWide2>
        <TopBox2>
          ...
          <TopBoxLink onClick={() => handleRefresh()}>
            <TopBoxText2>05. 표준 입출력 함수</TopBoxText2>
          </TopBoxLink>
        </TopBox2>
      </TopBoxWide2>
      <Container>
        ...
        <ClassContentsText>
          - 데이터를 화면에 출력하거나 사용자에게 메시지를 전달할 때 사용
          <br />- 이스케이프 문자를 사용해 줄바꿈, 탭 등을 추가할 수 있음
          <ClassContentsTextTab>
            · \n : 줄바꿈을 의미
            <br />
            · \t : 탭을 의미
        ...
        <ClassContentsTitle2>출력 옵션 : end와 sep</ClassContentsTitle2>
        <ClassContentsText>
          - end : 출력 후 삽입될 문자를 지정 (기본값은 \n)
          <br />- sep : 출력 값 사이에 삽입될 문자를 지정 (기본값은 공백)
          <br />
          <br />
        ...
        <ClassContentsText>
          - 사용자로부터 데이터를 입력받아 처리
          <br />
          - 기본적으로 문자열로 반환되며, 다른 데이터형으로 변환하려면 형변환
          함수를 사용해야 함
          <br />
          <br />
          ...
          - split() : 입력받은 문자를 공백 기준으로 분리하여 변수에 넣어주는
          역할을 함, 항상 공백 기준은 아니고 split(옵션)에 따라 기준이 달라짐
          <br />
          - map() : 리스트의 요소를 지정된 함수로 처리하는 함수(첫번째
          매개변수는 적용시킬 함수 또는 형, 두번째 매개변수는 반복 가능한
          자료형)
          <Python_01_05_Code07 />
        </ClassContentsText>
        ...
        <ClassContentsText>
          ...
          <ClassContentsTextTab>
            - input()으로 사용자 입력 받기
            <br />
            - 반환값은 문자열이며, 필요한 경우 형변환 필요 (int(), float() 등)
            <br />
          </ClassContentsTextTab>
          3. 정렬 및 포맷 :
          <ClassContentsTextTab>
