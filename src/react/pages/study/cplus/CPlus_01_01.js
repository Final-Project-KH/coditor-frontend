            ...
            <ClassContentsContainer>
              <ClassContentsText>
                <i>
                  ...
                  C++은 C 언어와 마찬가지로 시스템 프로그래밍이나 임베디드
                  시스템에서 많이 사용되며, 게임 개발, 알고리즘 문제 풀이,
                  머신러닝 등 다양한 분야에서도 사용됩니다.
                </i>
              </ClassContentsText>
              <hr />
              ...
              <ClassContentsText>
                ...
                만들어짐
                <br />
                · 절차 지향 언어의 특성과 객체 지향 언어의 특성을 모두 가지고
                있음
                <br />
                · 모듈화 및 재사용 특성 등으로 인해 대형 프로젝트에 유리
                <br />
                · C언어와 마찬가지로 컴파일 언어이며 C언어 특성을 그대로 가지고
                있음
              ...
              <ClassContentsText>
                ...
                <br />
                <ClassContentsTextTab>
                  - 객체 내부의 멤버를 숨기는 방법은 접근제한자를 통해서 이루어
                  진다.
                  <br />
                ...
                <ClassContentsTextTab>
                  ...
                  게임 구현등에 많이 사용 됨.
                  <br />
                  - C++에서는 다중 상속을 지원하고 있으며, 이로 인해 여러가지
                  문제점이 발생할 수 있음
                  <br />
                </ClassContentsTextTab>
                ·{" "}
              ...
              <ClassContentsText>
                ...
                언어 보다는 엄청 빠름)
                <br />
                · 객체가 많아 질수록 용량이 커진다. (상속 관계가 복잡해지면 계속
                커짐)
                <br />
