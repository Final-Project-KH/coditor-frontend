      ...
      <TopBoxWide2>
        <TopBox2>
          ...
          <TopBoxLink onClick={() => handleRefresh()}>
            <TopBoxText2>01. 자바스크립트 개요</TopBoxText2>
          </TopBoxLink>
        </TopBox2>
      </TopBoxWide2>
      <Container>
          ...
          <ClassContentsContainer> */}
            <ClassContentsText>
              <i>
                ...
                수 있습니다. 예를 들어, 사용자가 버튼을 클릭하면, 자바스크립트는
                새로운 콘텐츠를 로드하거나 웹 페이지의 스타일을 변경할 수
                있습니다.
              </i>
            </ClassContentsText>
            <hr />
            ...
            <ClassContentsText>
              ...
              스크립트 언어입니다. HTML과 CSS와 함께 웹 프론트엔드 개발에서
              중요한 역할을 하는 언어입니다. 자바스크립트는 사용자가 웹사이트를
              방문할 때 브라우저에서 실행되어 웹 페이지를 동적으로 변경하거나
              조작할 수 있게 해줍니다. 예를 들어, 사용자가 버튼을 클릭하면
              새로운 콘텐츠를 로드하거나 페이지 스타일을 바꿀 수 있습니다.
              <br />
              또한, 자바스크립트는 서버 측에서도 사용될 수 있습니다.{" "}
              <b>Node.js</b>라는 런타임 환경을 사용하면 서버에서 자바스크립트를
              실행할 수 있으며, 이를 통해 데이터베이스 작업이나 웹
              애플리케이션의 백엔드 개발도 가능합니다.
            </ClassContentsText>
            <br />
            ...
            <ClassContentsText>
              ...
              생성한 후에도 속성이나 메서드를 동적으로 추가하거나 삭제할 수 있는
              유연성이 특징입니다. 이는 Java나 C++과 같은{" "}
            ...
            <ClassContentsText>
              ...
              사용할 수 있게 해줍니다. 이를 통해 데이터 은닉이나 특정 상태를
              유지할 수 있습니다.
            </ClassContentsText>
            <br />
            ...
            <ClassContentsText>
              ...
              지원합니다. 함수가 객체로 취급되기 때문에, 함수 자체를 다른
              객체처럼 다룰 수 있습니다.
            </ClassContentsText>
