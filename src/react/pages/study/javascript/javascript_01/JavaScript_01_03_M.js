  ...
  return (
    <Wrap>
      ...
      <Container>
        ...
        <ClassContentsText>
          자바스크립트(JavaScript)에서는 코드 내에 주석을 추가하여 코드를
          설명하거나, 코드 실행 중에 무시되어야 하는 부분을 나타낼 수 있습니다.
          주석은 코드를 읽기 쉽게 만들어주며, 코드를 수정하거나 유지보수할 때
          유용합니다.
        </ClassContentsText>
        <br />
        ...
        <ClassContentsText>
          자바스크립트 스타일 가이드는 개발자들이 일관된 코드 스타일을 사용하여
          코드를 작성하도록 돕는 규칙입니다. 일관된 스타일은 코드의 가독성과
          유지보수성을 높이는 데 도움이 됩니다.
          <ClassContentsTextTab>
        ...
        <ClassContentsText>
          <ClassContentsTextTab>
            ...
            <br />
            - 단어를 연결하여 식별자를 작성할 때는 카멜표기법(camelCase)이나
            언더스코어(_)를 사용합니다.
        ...
        <ClassContentsText>
          ...
          <ClassContentsTextTab>
            - <b>변수 선언</b> : var, let, const 키워드를 사용합니다. ES6
            이후에는 let과 const를 주로 사용합니다.
            <br />
        ...
        <ClassContentsText>
          호이스팅은 변수 및 함수 선언이 스코프의 최상단으로 끌어올려지는
          자바스크립트의 동작 방식입니다. 변수나 함수를 선언하기 전에 사용할 수
          있지만, 변수의 초기화가 아닌 선언만 끌어올려지기 때문에, 선언 전에는{" "}
          <b>undefined</b>로 초기화됩니다.
        ...
        <ClassContentsText>
          원시 타입에 속하지 않는 자바스크립트의 값은 객체라고 합니다. 객체는
          변수 여러 개가 모여서 만들어진 복합 데이터 타입입니다.
          자바스크립트에서는 배열, 함수, 정규 표현식과 같은 다양한 요소가 객체
          입니다.
        </ClassContentsText>
        <ClassContentsImage
          style={{
        ...
        <ClassContentsText>
          자바스크립트의 문자열은 길이가 16비트인 유니코드 문자(UTF-16)를 나열한
          것으로 전 세계에서 사용하는 문자를 대부분 표현할 수 있습니다. 문자열
          리터럴은 작은 따옴표(’’)나 큰따옴표(””)를 문자열로 앞뒤에 붙여서
          표현합니다.
        ...
        <ClassContentsText>
          자바스크립트는 모든 숫자를 하나의 숫자형으로 다루며, 실수를 부동소수점
          방식으로 표현합니다. 이 방식은 정확한 실수 계산에 문제가 있을 수
          있습니다. 이를 해결하려면 BigInt를 사용하거나 BigDecimal 같은
          라이브러리로 정밀도를 높여 계산하는 것이 좋습니다.
          <br />
          <br />
          <b>문제 예시</b>
        ...
        <ClassContentsText>
          논리 자료형은 참 또는 거짓에 해당하는 논리 값인 true와 flase를
          의미합니다.
        ...
        <ClassContentsText>
          변수나 상수를 컴퓨터 메모리 공간에 선언하면 반드시 생성한 공간에
          저장할 데이터를 할당해야 합니다. 할당하지 않을 경우 자바스크립트
          내부적으로 젼수와 상수 공간에 임시로 데이터를 할당하는데, 이 때
          할당되는 값이 undefined 입니다.
        ...
        <ClassContentsText>
          null 자료형은 null 값 하나만 있으며, 변수나 상수를 선언하고 의도적으로
          선언한 공간을 비워 둘 때 할당 합니다.
        ...
        <ClassContentsText>
          객체(object)는 자바스크립트의 핵심적인 자료형 입니다. 기본 자료형을
          제외하고 자바스크립트의 거의 모든 데이터와 자료구조는 객체 입니다.
          <br />
        ...
        <ClassContentsText>
          ...
          <br />
          배열로 정의한 데이터를 요소라고 하며, 배열의 요소를 접근하려면
          인덱스를 이용 합니다.
          <br />
          배열의 데이터의 위치를 나타내는 인덱스는 0 부터 시작 합니다.
          <br />
          빈 배열을 선언 할 수 있습니다. (나중에 데이터를 동적으로 추가 위해
          사용)
        ...
        <ClassContentsText>
          ...
          <b>
            객체 리터럴은 객체를 정의할 때 중괄호{}를 사용하며, 중괄호 안에는
            키와 값의 한쌍으로 이루어진 속성
          </b>
          이 들어 갑니다.
          <ClassContentsImage
          ...
          아래의 배열에서 국어, 영어, 수학, 과학 성적 저장 시 값의 의미를 파악할
          수 없습니다.
        ...
        <ClassContentsText>
          배열 안의 모든 문자를 쉼표(,)를 이용해 모두 결합해서 하나의 문자열로
          반환 합니다.
        ...
        <ClassContentsText>
          비교 연산자는 피연산자를 비교한 뒤, 논리형 값인 참, 거짓으로 반환하는
          연산을 수행 합니다.
          <ClassContentsImage
            style={{
        ...
        <ClassContentsText>
          동등 연산자 (==): 두 값이 같은지 비교합니다. 자료형이 다를 경우
          자동으로 형변환이 일어납니다.
        ...
        <ClassContentsText>
          ...
          지정해주거나, 데이터 타입을 변환해주어야 할 필요가 있습니다. 이를
          형변환이라고 합니다.
        </ClassContentsText>
        <br />
        ...
        <ClassContentsText>
          자바스크립트는{" "}
          <b>
            숫자형 데이터와 문자열 데이터를 연결 연산자로 처리하면 문자열로 형
            변환
          </b>
          이 일어 납니다.
...
export default JavaScript_01_03_M;
