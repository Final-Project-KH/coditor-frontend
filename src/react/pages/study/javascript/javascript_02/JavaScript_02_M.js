      ...
      <TopBoxWide2>
        <TopBox2>
          <TopBoxLink onClick={() => handleRefresh()}>
            <TopBoxText2>02. 자바스크립트 응용</TopBoxText2>
          </TopBoxLink>
        </TopBox2>
      </TopBoxWide2>
      <Container>
        <JavaScript_Title_M />
        <JavaScript_ClassList_Filtered_M chapter="02" />
      </Container>
      <ScrollToTopButton />
    </Wrap>
  );
...
export default JavaScript_02_M;
