        ...
        {/* <EachClass>
          ...
          <ClassContentsContainer> */}
            ...
            <ClassContentsText>
              ...
              <br />
              좌측 피연산자가 정수 타입인 경우 나누는 수인 우측 연산자는 0을
              사용할 수 없습니다.
              <br />
              5 / 0.0 → Infinity (무한대)
              <br />
            ...
            <ClassContentsText>
              ...
              <ClassContentsTextTab>
                ...
                유의 해야 함)
                <br />
                - 대입연산자와 다른 연산자를 결합하여 다양한 복합 대입 연산자를
                제공 합니다.
                <br />
            ...
            <ClassContentsText>
              ...
              <br />
              - || : OR 연산자이며 A이거나 B, 즉 A와 B중 한개만 만족하면 참이
              된다.
              <br />
            ...
            <ClassContentsText>
              ...
              조작을 할 수 있습니다. 이러한 비트 연산자는 정수형 변수들의 비트를
              조작하고, 비트 패턴에 대한 다양한 연산을 수행할 때 사용됩니다.
              자바에서 제공하는 주요 비트 연산자는 다음과 같습니다.
              <br />
              <br />
              <ClassContentsCodeBox>
                ...
                <ClassContentsTextTab>
                  ...
                  있으며, 대부분의 고급 연산보다 훨씬 빠르게 실행됩니다. 이를
                  통해 메모리 접근, 연산 속도 등을 최적화할 수 있어, 성능이
                  중요한 저수준 프로그래밍(예: 임베디드 시스템, 시스템
                  프로그래밍, 게임 개발)에서 자주 사용됩니다.
                  <br />
                  2. <b>데이터 압축과 암호화</b>: 비트 연산을 사용하여 데이터를
                  압축하고 암호화하는 알고리즘을 구현할 수 있습니다. 이러한
                  알고리즘은 데이터를 효율적으로 저장하고 전송하는 데 필요한
                  비트 패턴을 조작하여 작동합니다.
                  <br />
                  3. <b>네트워킹</b>: IP 주소 처리, 서브네팅 계산 등 네트워크
                  주소를 계산하고 조작하는 데 비트 연산이 필수적으로 사용됩니다.
                  네트워크 프로토콜의 헤더 정보를 분석하거나 조작할 때도 비트
                  연산이 활용됩니다.
                  <br />
                  4. <b>플래그와 설정 관리</b>: 여러 설정이나 상태를 나타내는
                  플래그를 한 변수에 저장하고, 이를 효율적으로 관리하기 위해
                  비트 연산을 사용합니다. 예를 들어, 파일 시스템의 권한 설정,
                  소프트웨어의 구성 옵션 등을 비트로 표현하고 조작할 수
                  있습니다.
                  <br />
                  5. <b>그래픽스 프로그래밍</b>: 비트 연산은 픽셀 데이터를
                  처리하고, 이미지의 비트맵을 조작하는 데 사용됩니다. 예를 들어,
                  이미지 필터링, 색상 조정, 투명도 관리 등에 비트 연산이
                  사용됩니다.
                  <br />
                  6. <b>게임 개발</b>: 게임 상태 관리, 리소스 관리, 충돌 감지
                  등에서 비트 연산을 사용하여 데이터를 효율적으로 처리하고
                  상태를 관리합니다.
                  <br />
                  7. <b>하드웨어 인터페이스와 드라이버 개발</b>: 하드웨어 장치의
                  레지스터를 직접 조작하거나, 특정 하드웨어 기능을
                  활성화/비활성화할 때 비트 연산이 필수적으로 사용됩니다.
                  <br />
                  <br />
                </ClassContentsTextTab>
                비트 연산은 이러한 분야에서 데이터를 저수준에서 효율적으로
                처리하고, 메모리 및 성능 최적화를 달성하기 위해 널리 사용됩니다.
                비트 연산의 빠른 처리 속도와 정밀한 데이터 조작 능력은
                프로그래밍에서 매우 유용한 도구입니다.
              </ClassContentsCodeBox>
              <br />
            </ClassContentsText>
            ...
            <ClassContentsText>
              두 비트가 서로 <b>다를 경우에만 1을 반환</b>하고, 같을 경우에는
              0을 반환합니다.
            </ClassContentsText>
            ...
            <ClassContentsText>
              ...
              <ClassContentsCodeBox>
                ...
                <ClassContentsTextTab>
                  ...
                  <br />
                  - 이진(binary) 숫자 시스템으로 표현되며, 0 또는 1의 두 가지
                  값을 가집니다.
                  <br />
                  - 비트는 정보의 여부를 표시하는 데 사용됩니다. 예를 들어, 두
                  가지 상태를 표현할 수 있습니다. (예: 참/거짓, 켜짐/꺼짐 등)
                  <br />
                  <br />
                </ClassContentsTextTab>
