...
import Java_02_01_M from "./Java_02_01_M";
              ...
              <EachClass>
                ...
                <ClassContentsContainer>
                  <ClassContentsText>
                    ...
                    저장하고 표현하는지, 그리고 이러한 값을 어떻게 컴퓨터가
                    이해할 수 있게하는지 알아보겠습니다.
                  </ClassContentsText>
                  <br />
                  <ClassContentsTitle1>
                  ...
                  <ClassContentsText>
                    우리가 사용하는 모든 데이터는 컴퓨터 내부에서 0과 1로
                    이루어져 있습니다. 컴퓨터 내부를 구성하는 반도체가 0과 1로만
                    표현 할 수 있기 때문 입니다. 이렇게 0 또는 1로 표현할 수
                    있는 최소 단위를 비트(bit)라고 하며, 8비트가 모이면
                    1바이트(Byte)가 됩니다.
                  </ClassContentsText>
                  <ClassContentsTitle3>10진수와 2진수</ClassContentsTitle3>
                  <ClassContentsText>
                    우리가 일상 생활에서 사용하는 숫자는 0부터 9까지 한
                    자릿수이고 10부터는 두 자릿수가 됩니다. 이를 10진수라고
                    합니다. 하지만 컴퓨터 내부에서는 모든 데이터를 0과 1로
                    표현해야 합니다. 이 때 사용하는 것이 바로 2진수 입니다.
                    ...
                    예를 들어 A라는 문자가 있을 때 A는 숫자 65라는 값으로
                    표현하도록 약속되어 있습니다. 이를 2진수로 표현하면
                    1000001로 표현 됩니다. 이 값을 A 문자의
                    아스키(ASCII)값이라고 합니다.
                  </ClassContentsText>
                  <ClassContentsTitle3>
                    부호 있는 수를 표현하는 방법
                  ...
                  <ClassContentsText>
                    컴퓨터에서 숫자를 표현 할 때 양수와 음수를 어떻게
                    표현할까요? 컴퓨터는 숫자를 0과 1로만 표현할 수 있기 때문에
                    부호 또한 0과 1로 표현합니다. 부호를 나타내는 비트는 맨 앞에
                    붙이며 부호 비트(MSB)라고 부릅니다. 부호 비트가 0이면 양수,
                    1이면 음수를 나타냅니다.
                  </ClassContentsText>
                  ...
                  <ClassContentsText>
                    ...
                    <ClassContentsTextTab>
                      ...
                      <ClassContentsCodeBox>
                        ...
                        1. 3을 이진수로 나타냅니다: 0000 0000 0000 0000 0000
                        0000 0000 0011
                        <br />
                        2. 모든 비트를 반전시킵니다: 1111 1111 1111 1111 1111
                        1111 1111 1100
                        <br />
                    ...
                    ☘️  자바에서 음수를 2의 보수로 표기하는 이유는 컴퓨터
                    시스템에서 산술 연산을 간단하고 효율적으로 처리하기
                    위해서입니다.
                  </ClassContentsText>
                  <br />
                  ...
                  <ClassContentsText>
                    변수란? 값을 저장할 수 있는{" "}
                    <b>메모리 공간에 이름을 붙여 놓은 것.</b>
                    <br />
                    프로그램은 변수를 통해 특정 번지에 값을 저장하고 읽을 수
                    있습니다.
                    <br />
                    대부분의 프로그래밍 언어는 메모리 공간에 저장할 위치를
                    운영체제가 결정하지만 <b>자바는 JVM</b>이 합니다.
                    <br />
                    (JVM이 운영체제로 부터 대량의 메모리를 미리 할당 받아두고
                    이를 재 할당)
                    <br />
                    자바는 데이터형이 존재하는 언어 이기 때문에 선언시 사용
                    데이터에 맞는 자료형을 선언해야 합니다.
                  </ClassContentsText>
                  <br />
                  <ClassContentsTitle2>변수의 선언</ClassContentsTitle2>
                  <ClassContentsText>
                    변수를 사용하기 위해서는 먼저 변수를 선언해야 합니다. 변수의
                    선언은 어떤 타입의 데이터를 저장할 것인지 그리고 변수 이름이
                    무엇인지를 결정해야 합니다.
                    <br />
                    <br />
                    <Java_02_01_Code01 />
                  ...
                  <ClassContentsText>
                    자바에서는 변수 뿐만 아니라 클래스, 매소드 등의 이름을
                    짓는데 반드시 지켜야 하는 공통된 규칙이 있습니다.
                    <ClassContentsTextTab>
                      ...
                      <br />
                      4. 변수의 이름으로 자바에서 미리 정의된 키워드(keyword)는
                      사용할 수 없습니다.
                      <br />
                      5. **camel 표기법**을 따릅니다.
                      <br />
                  ...
                  <ClassContentsText>
                    ...
                    <br />
                    수학에서 등호(=) 같다는 표시이지만 프로그래밍 언어에서는
                    오른쪽 값을 왼쪽 변수에 저장 한다는 의미 입니다.
                    <br />
                    <br />
                    <Java_02_01_Code06 />
                    <br />
                  ...
                  <ClassContentsText>
                    변수는 컴퓨터 내부의 메모리 공간에 저장됩니다. 메모리는
                    프로그램이 실행되는 작업 공간 입니다. 즉 int level; 문장을
                    선언하면, 메모리에 4바이트 크기의 공간이 level 이라는
                    이름으로 할당됩니다.
                  </ClassContentsText>
                  <br />
                  <ClassContentsTitle2>
                  ...
                  <ClassContentsText>
                    자바에서 제공하는 자료형은 <b>기본 자료형과 참조 자료형</b>
                    이 있습니다.
                  </ClassContentsText>
                  ...
                  <ClassContentsText>
                    부호를 가지며, 소수가 없습니다.
                    <br />
                    정수형 데이터 타입을 결정 할 때는 사용하고자 하는 데이터의
                    최대크기를 고려해서 결정해야 합니다.
                    <br />
                    해당 타입이 표현 할 수 있는 범위를 벗어나면 오버플로우가
                    발생해 전혀 다른 값이 저장 됩니다.
                    <br />
                    <br />
                    <ClassContentsTextTab>
                      ...
                      : 16비트, 부호 있는 정수, -32,768에서 32,767까지의 값 저장
                      가능
                      <br />-{" "}
                      <font color="red">
                        <b>int</b>
                      </font>{" "}
                      : 32비트, 부호 있는 정수, -2^31에서 2^31-1까지의 값 저장
                      가능
                      <br />-{" "}
                      <font color="red">
                        <b>long</b>
                      </font>{" "}
                      : 64비트, 부호 있는 정수, -2^63에서 2^63-1까지의 값 저장
                      가능
                      <br />
                      <br />
                    </ClassContentsTextTab>
                  ...
                  <ClassContentsText>
                    <ClassContentsTextTab>
                      -{" "}
                      <b>
                        컴퓨터는 0과 1로만 표현 할 수 있으므로 문자 역시 컴퓨터
                        내부에서 표현 할 때 0과 1의 조합
                      </b>
                      <br />
                      - 어떤 문자를 컴퓨터 내부에서 표현하려면 특정 정수 값으로
                      정하자고 약속
                      <br />
                      - 예를 들어 A를 얼마로 표현할 것인지 약속하는데, 이런 코드
                      값을 모안 둔 것을 ‘문자 세트’라고 하고 문자를 정해진 코드
                      값으로 변환하는 것을 ‘문자 인코딩’이라고 합니다. 반대로
                      코드 값을 다시 문자로 변환하는 것을 ‘디코딩’이라고 합니다.
                      <br />
                      <br />
                    </ClassContentsTextTab>
                    프로그래밍 언어에서 가장 기본이 되는 문자 인코딩은
                    아스키(ASCII) 코드이며, 주로 C언어에서 사용하는 방식 입니다.{" "}
                    <b>
                      아스키(ASCII) 코두 방식은 1바이트로 영문자, 숫자,
                      특수문자를 표현하는 방식
                    </b>
                    ...
                    <ClassContentsCodeBox>
                      ...
                      <br />
                      <ClassContentsTextTab>
                        미국정보교환표준부호(영어: American Standard Code for
                        Information Interchange), 또는 줄여서
                        ASCII( /ˈæski/, 아스키)는 영문 알파벳을 사용하는
                        대표적인 문자 인코딩이다. 아스키는 컴퓨터와 통신 장비를
                        비롯한 문자를 사용하는 많은 장치에서 사용되며, 대부분의
                        문자 인코딩이 아스키에 기초를 두고 있다.
                      </ClassContentsTextTab>
                    </ClassContentsCodeBox>
                    <br />
                    <br />
                    자바에서 문자(char)는 16비트 유니코드(Unicode) 문자를
                    나타내는 데 사용됩니다.
                    <br />
                    <br />
                    <Java_02_01_Code10 />
                  ...
                  />
                  <ClassContentsText>
                    - 자바에서 실수는 부동소수점 숫자로 표현 (지수와 가수를
                    구분하여 표현하는 방식)
                    <br />
                    - 부동소수점은 정수부와 소수부로 구성된 숫자를 나타내는
                    방식(두 가지 부동소수점 자료형 제공)
                    <br />
                    - 컴퓨터에서 실수를 표현하는 방법은 정수에 비해 훨씬 복잡
                    <br />
                    - 부동 소수점 방식을 사용하며, 고정 소수점 방식에 비해 훨씬
                    더 많은 범위까지 표현 가능
                    <br />
                    - 컴퓨터에서 실수를 표현하는 방법은 정확한 값이 아니라
                    언제자 근사치를 표현하므로 오차가 발생
                    <br />
                    ...
                    실수를 표현하는 방식에서는 반올림 오차와 같은 부동소수점
                    연산에 따르는 정확도 제한에 주의
                    <br />
                    ...
                    <br />
                    지수와 가수로 나타내는 부동 소수점 방식은 지수로 표현되는
                    값이 0을 나타낼 수 없습니다. 따라서 부동 소수점 값을
                    연산하면 약간의 오차가 발생할 수 있습니다.
                    <br />
                    <br />
                    <Java_02_01_Code13 />
                    <br />
                  ...
                  <ClassContentsText>
                    - 상수(constant)란 변수와 마찬가지로 데이터를 저장할 수 있는
                    메모리 공간을 의미
                    <br />
                    - 상수가 변수와 다른 점은 프로그램이 실행되는 동안 메모리에
                    저장된 데이터를 변경할 수 없다는 점<br />- 자바에서는{" "}
                    <b>final 키워드를 사용하여 선언</b>
                    <br />
                    - 상수 이름은 관례상 대문자를 주로 사용하고, 여러 단어를
                    연결하는 경우에 _기호를 사용
                    <br />
                    <br />
                  </ClassContentsText>
                  ...
                  <ClassContentsText>
                    프로그램 내부에서 반복적으로 사용하고, 변하지 않아야 하는
                    값을 상수로 선언하여 사용하면 좋습니다. <br />
                    <br />
                    <Java_02_01_Code16 />
                    <br />
                  </ClassContentsText>
                  ...
                  <ClassContentsText>
                    ...
                    <br />
                    <b>
                      리터럴은 프로그램이 시작 할 때 시스템에 같이 로딩되어 특정
                      메모리 공간인 상수 풀
                    </b>
                    에 놓입니다.
                    <br />
                  ...
                  <ClassContentsText>
                    하나의 타입을 다른 타입으로 바꾸는 것을 타입 변환이라고
                    합니다.
                    <br />
                    자바에서는 다른 타입끼리 연산의 경우 모두 같은 타입으로
                    변환이 후 수행이 됩니다.
                    <br />
                  </ClassContentsText>
                  <br />
                  ...
                  <ClassContentsText>
                    자동 타입 변환이라고도 하며 컴파일러가 유리한 방향으로 형을
                    변환 합니다.
                  </ClassContentsText>
                  <ClassContentsTitle2>명시적 형 변환</ClassContentsTitle2>
                  <ClassContentsText>
                    개발자가 의도를 명확한 목적을 가지고 형을 변환하는 것을 의미
                    합니다.
                    <br />
                    <br />
                    <Java_02_01_Code18 />
