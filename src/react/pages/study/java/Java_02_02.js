      ...
      <TopBoxWide>
        <TopBox>
          ...
          <a href="/study/java/02/02" className="menu-link">
            <TopBoxText>변수와 시스템 입출력</TopBoxText>
          </a>
        </TopBox>
      </TopBoxWide>
      <Container>
          ...
          <EachClass>
            ...
            <ClassContentsContainer>
              ...
              <ClassContentsText>
                ...
                <br />
                자바에서는 모든 것이 객체로 표현되므로, 입출력을 담당하는 수단
                또한 모두 객체 입니다.
                <br />
                <br />
                <ClassContentsTextTab>
                  ...
                  표준 입력 스트림으로, 프로그램 내에서 사용자로부터의 입력을
                  받을 수 있도록 합니다.
                  <br />-{" "}
                  <font color="#2c79c1">
                    <i>System.out</i>
                  </font>{" "}
                  표준 출력 스트림으로, 프로그램 내에서 결과를 콘솔에 출력할 수
                  있도록 합니다.
                  <br />-{" "}
                  <font color="#2c79c1">
                    <i>System.err</i>
                  ...
                  관련된 정보를 콘솔에 출력할 때 사용됩니다. (리다이렉션이 되지
                  않습니다.)
                  <br />
                  <br />
                </ClassContentsTextTab>
              ...
              <ClassContentsText>
                ...
                하지만,{" "}
                <b>
                  java.lang 패키지에 속하는 System 클래스를 이용하면 운영체제의
                  일부 기능을 이용
                </b>
                할 수 있습니다.
                <br />
                즉 프로그램의 종료, 키보드 입력, 모니터 출력, 메모리 정리, 현재
                시간 읽기, 시스템 환경 변수 읽기 등이 가능 합니다.
                <br />
              ...
              <ClassContentsText>
                키보드에서 키 하나를 입력하면 프로그램에서는 숫자로 된 키보드를
                읽을 수 있습니다.
                <br />
                <font color="red">
                ...
                <br />
                자바는 일출력에 대한 예외에 대해서 까다롭게 규정하고 있습니다.
                그래서 입/출력 을 다루는 메서드에서 예외처리가 없다면 컴파일
                에러가 발생하게 됩니다.
                <br />
                <br />
                <font color="red">
              ...
              <ClassContentsText>
                ...
                nextInt() 를 사용하여 입력받으면 알아서 해당 타입으로 입력된다.
                <br />
                2. Scanner 을 사용할 시 util 패키지를 경로의 Scanner 클래스를
                호출해야 합니다.
                <br />
                Scanner 클래스는 java.utiil 패키지내에 존재하므로 import해줘야
                합니다.
                <br />
              ...
              <ClassContentsText>
                ...
                <br />
                Scanner 생성자에는 사용자로 부터 입력을 받기 위한 입력 스트림을
                지정 합니다.
              </ClassContentsText>
