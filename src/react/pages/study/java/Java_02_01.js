          ...
          <EachClass>
            ...
            <ClassContentsContainer>
              ...
              <ClassContentsText>
                ...
                있습니다. 컴퓨터 내부를 구성하는 반도체가 0과 1로만 표현 할 수
                있기 때문 입니다. 이렇게 0 또는 1로 표현할 수 있는 최소 단위를
              ...
              <ClassContentsText>
                ...
                10부터는 두 자릿수가 됩니다. 이를 10진수라고 합니다. 하지만
                컴퓨터 내부에서는 모든 데이터를 0과 1로 표현해야 합니다. 이 때
                사용하는 것이 바로 2진수 입니다. 2진수란 0과 1 두 개로만
                표현되는 수를 말합니다.
                <br />
                <br />
                ...
                예를 들어 A라는 문자가 있을 때 A는 숫자 65라는 값으로 표현하도록
                약속되어 있습니다. 이를 2진수로 표현하면 1000001로 표현 됩니다.
                이 값을 A 문자의 아스키(ASCII)값이라고 합니다.
              </ClassContentsText>
              <ClassContentsTitle3>
                부호 있는 수를 표현하는 방법
              </ClassContentsTitle3>
              <ClassContentsText>
                컴퓨터에서 숫자를 표현 할 때 양수와 음수를 어떻게 표현할까요?
                컴퓨터는 숫자를 0과 1로만 표현할 수 있기 때문에 부호 또한 0과
                1로 표현합니다. 부호를 나타내는 비트는 맨 앞에 붙이며 부호
                비트(MSB)라고 부릅니다. 부호 비트가 0이면 양수, 1이면 음수를
                나타냅니다.
              </ClassContentsText>
              ...
              <ClassContentsText>
                ...
                <ClassContentsTextTab>
                  ...
                  <ClassContentsCodeBox>
                    ...
                    1. 3을 이진수로 나타냅니다: 0000 0000 0000 0000 0000 0000
                    0000 0011
                    <br />
                    2. 모든 비트를 반전시킵니다: 1111 1111 1111 1111 1111 1111
                    1111 1100
                    <br />
              ...
              <ClassContentsText>
                ...
                <br />
                (JVM이 운영체제로 부터 대량의 메모리를 미리 할당 받아두고 이를
                재 할당)
                <br />
              ...
              <ClassContentsText>
                자바에서는 변수 뿐만 아니라 클래스, 매소드 등의 이름을 짓는데
                반드시 지켜야 하는 공통된 규칙이 있습니다.
                <ClassContentsTextTab>
              ...
              <ClassContentsText>
                ...
                <br />
                수학에서 등호(=) 같다는 표시이지만 프로그래밍 언어에서는 오른쪽
              ...
              <ClassContentsText>
                ...
                최대크기를 고려해서 결정해야 합니다.
                <br />
                해당 타입이 표현 할 수 있는 범위를 벗어나면 오버플로우가 발생해
                전혀 다른 값이 저장 됩니다.
                <br />
                <br />
                <ClassContentsTextTab>
              ...
              <ClassContentsText>
                <ClassContentsTextTab>
                  ...
                  값으로 변환하는 것을 ‘문자 인코딩’이라고 합니다. 반대로 코드
                  값을 다시 문자로 변환하는 것을 ‘디코딩’이라고 합니다.
                  <br />
                  <br />
                </ClassContentsTextTab>
                ...
                <br />
                <br />
                자바에서 문자(char)는 16비트 유니코드(Unicode) 문자를 나타내는
                데 사용됩니다.
                <br />
                <br />
                <ClassContentsCodeBox>
              ...
              <ClassContentsText>
                ...
                표현하는 방식)
                <br />
                - 부동소수점은 정수부와 소수부로 구성된 숫자를 나타내는 방식(두
                가지 부동소수점 자료형 제공)
                <br />
                - 컴퓨터에서 실수를 표현하는 방법은 정수에 비해 훨씬 복잡
                <br />
                - 부동 소수점 방식을 사용하며, 고정 소수점 방식에 비해 훨씬 더
                많은 범위까지 표현 가능
                <br />
                - 컴퓨터에서 실수를 표현하는 방법은 정확한 값이 아니라 언제자
                근사치를 표현하므로 오차가 발생
                <br />
                ...
                실수를 표현하는 방식에서는 반올림 오차와 같은 부동소수점 연산에
                따르는 정확도 제한에 주의
                <br />
                ...
                <br />
                지수와 가수로 나타내는 부동 소수점 방식은 지수로 표현되는 값이
                0을 나타낼 수 없습니다. 따라서 부동 소수점 값을 연산하면 약간의
                오차가 발생할 수 있습니다.
                <br />
                <br />
                <ClassContentsCodeBox>
