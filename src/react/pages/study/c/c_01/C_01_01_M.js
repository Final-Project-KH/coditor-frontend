...
const C_01_01_M = () => {
  ...
  return (
    <Wrap>
      ...
      <TopBoxWide2>
        <TopBox2>
          <TopBoxLink onClick={() => handleStudyC01()}>
        ...
        {/* <EachClass>
          ...
          <ClassContentsContainer> */}
            ...
            <ClassContentsText>
              ...
              언어입니다. 주로 <b>시스템 프로그래밍</b>과 <b>운영 체제 개발</b>
              을 목적으로 만들어졌으며, UNIX 운영 체제를 개발하는 데 중요한
              역할을 했습니다.
            </ClassContentsText>
            <hr />
            ...
            <ClassContentsText>
              ...
              빠름
              <br />· <b>유연성과 확장성</b> : 시스템 프로그래밍, 게임, 임베디드
              등 다양한 분야에서 활용
              <br />· <b>직접 메모리 제어 가능</b> : 효율적인 메모리 최적화 가능
              <br />· <b>높은 이식성</b> : 플랫폼 종속성이 낮아 코드 재사용성이
              좋음
